...
describe('verifica as funções e os mocks', () => {
  ...
  mockFunctions.factorial.mockImplementation((a) => {
    // Algoritmo reproduzido de pesquisa realizada no google sobre fatoração, segue link: https://www.freecodecamp.org/news/how-to-factorialize-a-number-in-javascript-9263c89a4b38/
    var result = a;
    if (a === 0 || a === 1) 
      return 1; 
    while (a > 1) { 
