...
describe('verifica as funções e os mocks', () => {
  test('testa função add', () => {
    const newAdd = jest.spyOn(mockFunctions, 'add');
    newAdd.mockImplementation((a, b) => a + b);
  ...
  test('testa função subtract', () => {
    const newSubtract = jest.spyOn(mockFunctions, 'subtract');
    newSubtract.mockImplementation((a, b) => a - b);
  ...
  test('testa função multiply', () => {
    const newMultiply = jest.spyOn(mockFunctions, 'multiply');
    newMultiply.mockImplementation((a, b) => a * b);
  ...
  test('testa função divide', () => {
    const newDivide = jest.spyOn(mockFunctions, 'divide');
    newDivide.mockImplementation((a, b) => a / b);
  ...
  test('testa função power', () => {
    const newPower = jest.spyOn(mockFunctions, 'power');
    newPower.mockImplementation((a, b) => a ** b);
