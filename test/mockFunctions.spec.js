...
describe('verifica as funções e os mocks', () => {
  ...
  mockFunctions.multiply = jest.fn(mockFunctions.multiply).mockImplementation((a, b) => a * b);
  mockFunctions.divide = jest.fn(mockFunctions.divide).mockImplementation((a, b) => a / b);
  mockFunctions.power = jest.fn(mockFunctions.power).mockImplementation((a,b) => Math.pow(a,b));
