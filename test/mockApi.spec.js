...
- País: Brasil
- E: tunicao123
- Senha: 1234567890 (Usem smail: tunico@bol.com.br (Sim, é um email do bol mesmo...)
- Nome de usuárioenhas fortes, crianças!)
...
describe('verifica o usuário', () => {
  ...
  test('verifica se o usuário é o tunico', async () => {
    api.fetchURL = jest.fn(api.fetchURL).mockResolvedValue(user);
